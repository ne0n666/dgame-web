...
angular.module('myApp.controllers', [])
  .controller('PlayController', ['$scope', function($scope) {
    var colors = ["#56af34","#123456", '#dad990', '#b83d3d', '#5bc8b0', '#3a5c1f', '#184936', '#4f82c4', '#286077', '#4a1d48', '#c3654b', '#c4994f', '#7353c6', '#d0cb71', '#c25047'];
  	var titles = ["Take 1", "Give 4", "Give 2", "Guys drink", "Ladies drink", "Everyone drinks", "New rule", "Pick a mate", "Rhymes", "Boom", "Never have I ever...", "Categories", "Waterfalls", "Fuzzy Duck", "Just DANCE!", "Hands UP!", "Questions", "Let's go camping", "Rock, paper scissors", "Puzzle", "Fast ABCs", "Kalodont", "Who shit?", "Sentences", "Stop - Go", "Thumper!", "Truth or Dare", "Sing for the Moment!"];
